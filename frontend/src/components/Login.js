  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        onLogin(token, { name: formData.name });
        navigate('/polls');
      } else {
        ...
        <div className="max-w-md w-full">
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8">
            <div className="text-center mb-8">
              <div className="mx-auto h-16 w-16 bg-gradient-to-r from-blue-400 to-purple-500 rounded-2xl flex items-center justify-center mb-4 shadow-lg">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="text-center">
                <Link to="/" className="font-medium text-blue-300 hover:text-blue-200 transition-colors">
                  Back to home
                </Link>
              </div>
            </form>
